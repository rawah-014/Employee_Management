...
A lightweight employee management dashboard built with **HTML5**, **CSS3**, and **modern vanilla JavaScript**. The application retrieves employee data from the [DummyJSON Users API](https://dummyjson.com/docs/users), organizes it through a modular client-side architecture, and provides practical tools for browsing and managing employee records.

[![HTML5](https://img.shields.io/badge/HTML5-E34F26?logo=html5&logoColor=white)](https://developer.mozilla.org/en-US/docs/Web/HTML)
[![CSS3](https://img.shields.io/badge/CSS3-1572B6?logo=css3&logoColor=white)](https://developer.mozilla.org/en-US/docs/Web/CSS)
[![JavaScript](https://img.shields.io/badge/JavaScript-ES6%2B-F7DF1E?logo=javascript&logoColor=black)](https://developer.mozilla.org/en-US/docs/Web/JavaScript)
[![Dependencies](https://img.shields.io/badge/dependencies-none-success)](#technology-stack)
...
| Technology | Purpose |
| --- | --- |
| HTML5 | Semantic page structure, controls, form, and dialog |
| CSS3 | Layout, table styling, filters, modal, and scrollable viewport |
| JavaScript ES6+ | Application logic, modules, models, components, and API integration |
| Fetch API | Retrieves employee data from DummyJSON |
| Blob and Object URL APIs | Generates downloadable CSV and JSON files |
...
| --- | --- |
| `EmployeeAPI` | Fetches users from DummyJSON and maps the response to the application's employee structure |
| `Employee` | Represents one employee and contains employee-specific search behavior |
| `EmployeeCollection` | Stores employees and provides add, delete, search, filter, and subscriber notification operations |
| `DataService` | Coordinates API access and exposes the employee collection to the application |
| UI components | Render the table, search control, department filter, pagination, and virtualized rows |
| `App` | Initializes the application, manages UI state, combines search and filtering, and coordinates rendering |
| Export helpers | Convert employee records to CSV or JSON and trigger browser downloads |
...
1. Wait for the employee records to load.
2. Enter a name, role, or department in the search field.
3. Select one or more departments to narrow the results further.
4. Use **Clear** to remove the department selection.
5. Select **Add Employee** to create a new in-memory record.
6. Select **Delete** beside an employee to remove that record.
7. Use **Export CSV** or **Export JSON** to download the current employee collection.
...
- GitHub: [@rawah-tech](https://github.com/rawah-tech)
- Repository: [Employee Management System](https://github.com/rawah-tech/Employee_Management)

## Acknowledgements

Demo employee data is provided by [DummyJSON](https://dummyjson.com/).
